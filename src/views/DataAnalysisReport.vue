<template>
    ...
    <div class="jumbotron">
      <div class="row">
          ...
          <div class="col-sm">
              <img src="../assets/EngPass.png" width="908" height="303"/>
    ...
    <div class="jumbotron" style="background-color: #F2F2F2; color: #38404B; margin-left:40px;margin-right:200px">
      <div class="row">
          ...
          <div class="col-sm">
              <img src="../assets/englandsummary.png" width="839" height="563"/>
          </div>
      </div>  
    ...
    <div class="jumbotron">
      <div class="row">
          ...
          <div class="col-sm">
              <img src="../assets/SpainPass.png" width="819" height="288"/>
          </div>
      </div>  
    ...
    <div class="jumbotron" style="background-color: #F2F2F2; color: #38404B; margin-left:40px;margin-right:200px;">
      <div class="row">
          ...
          <div class="col-sm">
              <img src="../assets/spainsummary.png" width="839" height="565"/>
          </div>
      </div>  
